...
class SampleControllerTests {
    ...
    void sampleRouteCreatesOwnerCookieAndRedirectsToReport() throws Exception {
        ...
        mockMvc.perform(get(result.getResponse().getRedirectedUrl()).cookie(ownerCookie))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Guided sample highlights")))
    ...
    void landingPageShowsSharpValuePropositionAndSampleCta() throws Exception {
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("citation-backed analysis")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Start in three ways")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Analyze PDF")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Vendor agreement")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Privacy policy")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Employment policy")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Campus / student policy")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Fictional sample. Demonstration only.")))
